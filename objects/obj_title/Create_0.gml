...
title_menu_maxpos = 5;              //current options: start game, options, credits, exit
title_load_maxpos = 0;
title_options_maxpos = 7;           //1 test menu option, defaults, discard, save
title_credits_maxpos = 0;
title_newgame_maxpos = 0;
draw_fadeout = false;
title_fadeout_time = 90;

load_sprite = spr_save_data;
if (file_exists( save_screen_name ) ) {
    load_sprite = sprite_add( save_screen_name, 1, false, false, 0, 0 );
}
